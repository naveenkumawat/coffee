/**
 * Product Module - Form Validation and Handling
...
(function () {
    ...
    /**
     * Main Product Module Handler
     */
    class ProductModuleHandler {
        constructor(config = {}) {
        ...
        init() {
            ...
            console.log("✅ Product Module initialized successfully");
        }
        ...
        initializeForms() {
            ...
            if (createFormElement) {
                console.log("📝 Initializing Product creation form");
                this.initializeCreateForm(createFormElement);
            }

            if (updateFormElement) {
                console.log("✏️ Initializing Product update form");
        ...
        /**
         * Initialize product update form
         */
        ...
        /**
         * Get validation rules for product forms
         */
        getValidationRules() {
            return {
                product_type_id: {
                ...
                product_type_variant_id: {
                    validators: {
                        notEmpty: {
                            message:
                                "Product Type Variant selection is required",
                        },
                        choice: {
                            min: 1,
                            max: 1,
                            message:
                                "Please select a valid Product Type Variant",
                        },
                    },
                },
                name: {
        ...
        static quickInit(config = {}) {
            return new ProductModuleHandler(config);
        }
        ...
        static getInstance(key = "default", config = {}) {
            ...
            if (!this._instances[key]) {
                this._instances[key] = new ProductModuleHandler(config);
            }
        ...
        destroy() {
            ...
            console.log("🧹 Product Module destroyed");
        }
    }

    // Expose to global scope
    if (typeof window !== "undefined") {
        window.ProductModule = ProductModuleHandler;
        console.log("🌍 Product Module exposed to global scope");
    }
    ...
    if (typeof document !== "undefined" && document.readyState === "loading") {
        document.addEventListener("DOMContentLoaded", () => {
            if (
                typeof window.AUTO_INIT_PRODUCT_MODULE !== "undefined" &&
                window.AUTO_INIT_PRODUCT_MODULE
            ) {
                new ProductModuleHandler();
            }
        });
    }
})();
