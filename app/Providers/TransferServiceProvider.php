...
class TransferServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(OrderTransferInterface::class, OrderTransfer::class);
        $this->app->bind(OrderFilterTransferInterface::class, OrderFilterTransfer::class);
        $this->app->bind(OrderStatusTransitionTransferInterface::class, OrderStatusTransitionTransfer::class);
