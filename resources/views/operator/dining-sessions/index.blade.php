...
@section('content')
    <div class="card card-flush internal-card internal-filter-card mb-7">
        <div class="card-body pt-6">
            <form method="GET" action="{{ route('operator.dining-sessions.index') }}" class="row g-4 align-items-end internal-filter-form">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <x-internal.button-group :items="[
                        ...
                        ['label' => 'Reset', 'url' => route('operator.dining-sessions.index'), 'variant' => 'dark', 'icon' => 'ki-arrows-circle'],
                    ]" />
                </div>
            </form>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <x-internal.action-dropdown :items="[
                                        ['label' => 'Open', 'url' => route('operator.dining-sessions.show', $session), 'icon' => 'ki-eye'],
                                    ]" />
                                </td>
                            </tr>
                        @empty
