...
@section('content')
    <div class="card card-flush internal-card internal-filter-card mb-7">
        <div class="card-body pt-6">
            <form method="GET" action="{{ route('operator.inventory.index') }}" class="row g-6 align-items-end internal-filter-form">
                ...
                <div class="col-xl-3 col-md-12">
                    <x-internal.button-group :items="[
                        ...
                        ['label' => 'Reset', 'url' => route('operator.inventory.index'), 'variant' => 'dark', 'icon' => 'ki-arrows-circle'],
                    ]" justify="start" />
                </div>
            </form>
        </div>
                                ...
                                <td class="text-end internal-action-cell">
                                    <x-internal.action-dropdown :items="[
                                        [
                                            ...
                                            'url' => route('operator.refill-requests.create', ['ingredient_id' => $ingredient->id]),
                                            'icon' => 'ki-plus-circle',
                                        ],
                                        [
                                            'label' => 'My Requests',
                                            'url' => route('operator.refill-requests.index', ['ingredient_id' => $ingredient->id]),
                                            'icon' => 'ki-time',
                                        ],
                                    ]" />
                                </td>
