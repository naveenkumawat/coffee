...
@section('toolbar-actions')
    <x-internal.button-group :items="[
        ['label' => 'Create New', 'url' => route('administrator.orders.create'), 'variant' => 'success', 'icon' => 'ki-plus'],
    ]" />
@endsection
...
@section('content')
    ...
    <div class="card card-flush internal-card internal-filter-card mb-7">
        <div class="card-body pt-6">
            <form method="GET" action="{{ route('administrator.orders.index') }}" class="row g-6 align-items-end internal-filter-form">
                ...
                <div class="col-xl-3 col-md-12">
                    <x-internal.button-group :items="[
                        ...
                        ['label' => 'Reset', 'url' => route('administrator.orders.index'), 'variant' => 'dark', 'icon' => 'ki-arrows-circle'],
                    ]" justify="start" />
                </div>
            </form>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end internal-action-cell">
                                    <x-internal.action-dropdown :items="[
                                        ['label' => 'View', 'url' => route('administrator.orders.show', $order), 'icon' => 'ki-eye'],
                                    ]" />
                                </td>
                            </tr>
                        @empty
