    ...
    <div class="card-body pt-0">
        <form method="POST" action="{{ $action }}" class="form">
            ...
            <div class="row g-6 mb-8 internal-form-grid">
                ...
                <div class="col-12">
                    <div class="form-text">Slug is generated automatically from the category name.</div>
                </div>
                <div class="col-12">
            ...
            <div class="form-check form-switch form-check-custom form-check-solid mb-10">
                ...
                <label class="form-check-label" for="is_active">Category is active for ingredient assignment</label>
            </div>

            <div class="d-flex justify-content-end internal-form-actions">
                <x-internal.button-group :items="[
                    ['label' => 'Cancel', 'url' => route('administrator.ingredients.categories.index'), 'variant' => 'dark', 'icon' => 'ki-left'],
